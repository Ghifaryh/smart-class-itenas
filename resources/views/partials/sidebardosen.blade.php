<div id="mySidenav" class="sidenav">
    ...
    <a href="{{ route('scr.index') }}" id="side1" class="asettext text-end">Home<i
    ...
    {{-- <a href="/dashboard" id="side2" class="asettext"><i class="fa-solid fa-pen-to-square logowsidebarw"></i>Pemesanan
        Ruangan</a> --}}
    <a href="{{ route('scr.dashboard') }}" id="side2" class="asettext text-end">Pemesanan
    ...
    @if (auth()->user()->level == 'admin')
        {{-- <a href="/truangan" id="side3" class="asettext"><i class="fa-solid fa-plus logowsidebaro"></i>Tambah
            Ruangan</a> --}}
        <a href="{{ route('scr.truangan') }}" id="side3" class="asettext text-end">Tambah
        ...
        <a href="{{ route('scr.verifakun') }}" id="side4" class="asettext text-end">Verifikasi Akun <i
        ...
        <a href="{{ route('scr.pengaturan') }}" id="side5" class="asettext text-end">Pengaturan<i
